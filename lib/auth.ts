        ...
        polar({
            ...
            use: [
                checkout({
                    products: [
                        {
                            productId: "1d095f7d-fa1d-483f-ae31-d8b310f16023",
                            slug: "BuildBeaver"
                        }
                    ],
                ...
                webhooks({
                    ...
                    onSubscriptionActive: async (payload) => {
                        ...
                        if (user) {
                            updateUserTier(user.id, "PRO", "ACTIVE", payload.data.id);
                        }
                    ...
                    onSubscriptionCanceled: async (payload) => {
                        ...
                        if (user) {
                            updateUserTier(user.id, user.subscriptionTier as any, "CANCELED");
                        }
                    },
                    onSubscriptionRevoked: async (payload) => {
                        ...
                        if (user) {
                            updateUserTier(user.id, "FREE", "EXPIRED");
                        }
                    },
                    onOrderPaid: async () => { },
