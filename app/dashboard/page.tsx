...
import { GitBranch, GitCommit, GitPullRequest, MessageSquare
 } from 'lucide-react';
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 md:grid-cols-4'>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>Total Pull Requests</CardTitle>
            <GitBranch className='h-4 w-4 text-muted-foreground'/>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>{isLoading ? "..." : stats?.totalPRs || 0}</div>
            <p className='text-xs text-muted-foreground'> All times</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>Total AI Reviews</CardTitle>
            <GitBranch className='h-4 w-4 text-muted-foreground'/>
          </CardHeader>
          <CardContent>
